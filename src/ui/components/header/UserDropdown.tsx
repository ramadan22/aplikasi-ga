  ...
  return (
    <div className="relative">
      ...
      >
        ...
        >
          <DefaultImage
            ...
            src={loginData?.user.image || undefined}
            alt="User"
          />
        </span>
      ...
      >
        ...
        <Button
          variant="outline"
          className="ring-0 dark:bg-transparent justify-start flex items-center gap-3 px-4 py-2 mt-3 text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
          onClick={() => signOut()}
        >
          <svg
