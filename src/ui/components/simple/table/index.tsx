...
const Table = React.forwardRef<HTMLTableElement, TableProps>(
  ({ className, classWrapper, ...props }, ref) => (
    <div
      className={cn(
        'relative w-full whitespace-nowrap overflow-x-auto scroll-customcn',
        classWrapper,
      )}
    >
      <table
...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      '[&_tr]:border-b [&_tr]:text-black/50 [&_tr]:py-6 sticky -top-[1px] z-[7] [&_tr]:border-gray-200 [&_tr]:dark:border-gray-800',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => <tr ref={ref} className={cn('py-4', className)} {...props} />);
